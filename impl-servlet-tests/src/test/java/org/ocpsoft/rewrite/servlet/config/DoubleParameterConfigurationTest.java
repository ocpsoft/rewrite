...
public class DoubleParameterConfigurationTest extends RewriteTest
{
   ...
   public static WebArchive getDeployment()
   {
      WebArchive deployment = RewriteTest.getDeployment()
               ...
               .addAsServiceProvider(ConfigurationProvider.class, DoubleParameterConfigurationTestProvider.class);
      return deployment;
   }
