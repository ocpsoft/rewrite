...
public interface Parameterized<T extends Parameterized<T>>
{
    ...
    * <p>
    * See also: {@link #where(String, String)}, {@link #where(String, String, Binding)},
    * {@link #where(String, Binding)}
    */
    ...
    * {@link #where(String, Binding)}
    */
   T where(String param, String pattern, Binding binding);
    ...
    * {@link #where(String, Binding)}
    */
   T where(String param, Binding binding);
}
