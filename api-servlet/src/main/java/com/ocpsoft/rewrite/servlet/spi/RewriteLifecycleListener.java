...
/**
 * Listens to {@link Rewrite} life-cycle events.
 * 
...
public interface RewriteLifecycleListener<T extends Rewrite> extends Specialized<Rewrite>, Weighted
{
   ...
   /**
    * Invoked after {@link RewriteProvider} services are processed on inbound {@link Rewrite} requests, but before
   ...
   /**
    * Invoked before {@link RewriteProvider} services are processed on outbound {@link Rewrite} events.
    */
   void beforeOutboundRewrite(T event);

   /**
    * Invoked after {@link RewriteProvider} services are processed on outbound {@link Rewrite} events.
    */
