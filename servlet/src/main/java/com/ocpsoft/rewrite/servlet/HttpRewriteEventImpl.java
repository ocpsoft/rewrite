...
import com.ocpsoft.rewrite.event.BaseRewriteEvent;
import com.ocpsoft.rewrite.exception.RewriteException;
import com.ocpsoft.rewrite.util.QueryString;

/**
 * @author <a href="mailto:lincolnbaxter@gmail.com">Lincoln Baxter, III</a>
 */
public class HttpRewriteEventImpl extends BaseRewriteEvent<HttpServletRequest, HttpServletResponse> implements
         HttpRewriteEvent
{
   Logger log = Logger.getLogger(HttpRewriteEventImpl.class);

   public HttpRewriteEventImpl(final HttpServletRequest request, final HttpServletResponse response)
   {
