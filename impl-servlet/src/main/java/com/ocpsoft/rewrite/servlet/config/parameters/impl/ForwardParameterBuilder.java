 ...
 */
public class ForwardParameterBuilder
{
   private final Forward parent;
   private final Parameter parameter;

   private ForwardParameterBuilder(final Forward parent, final Parameter parameter)
   {
      this.parent = parent;
      this.parameter = parameter;
   }

   public static ForwardParameterBuilder create(final Forward parent,
            final Parameter parameter)
   {
      return new ForwardParameterBuilder(parent, parameter);
   }

   public ForwardParameterBuilder matches(final String pattern)
   {
      parameter.matches(pattern);
      return this;
   }

   public ForwardParameterBuilder bindsTo(final ParameterBinding binding)
   {
      parameter.bindsTo(binding);
      return this;
   }

   public ForwardParameterBuilder attemptBindTo(final ParameterBinding binding)
   {
   ...
   public ForwardParameterBuilder where(final String param, final String pattern, final ParameterBinding binding)
   {
