...
public class FacesConverterProvider implements ConverterProvider
{
   ...
   public Converter<?> getByTargetType(Class<?> targetType)
   {
      ...
      jakarta.faces.convert.Converter converter = facesContext.getApplication().createConverter(targetType);
   ...
   public Converter<?> getByConverterId(String id)
   {
      ...
      jakarta.faces.convert.Converter converter = facesContext.getApplication().createConverter(id);
