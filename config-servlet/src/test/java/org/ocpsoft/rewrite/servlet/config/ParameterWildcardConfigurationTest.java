...
public class ParameterWildcardConfigurationTest
{
   ...
   public static WebArchive getDeployment()
   {
      WebArchive deployment = RewriteTest
               ...
               .addAsServiceProvider(ConfigurationProvider.class, ParameterWildcardConfigurationProvider.class);
      return deployment;
   }

   @Test
   public void testWildcardParameterCannotBeConfigured() throws Exception
   {}
}
