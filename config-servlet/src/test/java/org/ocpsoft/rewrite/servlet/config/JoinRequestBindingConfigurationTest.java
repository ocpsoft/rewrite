...
public class JoinRequestBindingConfigurationTest extends RewriteTest
{
   ...
   public static WebArchive getDeployment()
   {
      WebArchive deployment = RewriteTest
               ...
               .addAsServiceProvider(ConfigurationProvider.class, JoinRequestBindingConfigurationProvider.class);
      return deployment;
   }
