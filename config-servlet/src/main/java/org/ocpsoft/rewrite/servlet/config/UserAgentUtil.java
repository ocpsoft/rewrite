 ...
 */
class UserAgentUtil implements Serializable
{
   ...
   public void initDeviceScan() {
      ...
      this.isTierTablet = isTablet();
      this.isTierIphone = isHandset();
   ...
   public boolean detectTierOtherPhones() {
      if (detectMobileQuick() && (!isHandset()) && (!detectTierRichCss())) {
         return true;
      }
      return false;
   }
